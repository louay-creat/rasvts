...
#include "smartfleet_msgs/msg/detail/vehicle_state__rosidl_typesupport_fastrtps_c.h"
...
using _VehicleState__ros_msg_type = smartfleet_msgs__msg__VehicleState;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: capacity_remaining
  {
    cdr << ros_message->capacity_remaining;
  }

  // Field name: current_task_id
  {
    cdr << ros_message->current_task_id;
  }
...
size_t get_serialized_size_smartfleet_msgs__msg__VehicleState(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _VehicleState__ros_msg_type * ros_message = static_cast<const _VehicleState__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name capacity_remaining
  {
    size_t item_size = sizeof(ros_message->capacity_remaining);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name current_task_id
  {
    size_t item_size = sizeof(ros_message->current_task_id);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name is_available
...
static uint32_t _VehicleState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_smartfleet_msgs__msg__VehicleState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_smartfleet_msgs
size_t max_serialized_size_smartfleet_msgs__msg__VehicleState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = smartfleet_msgs__msg__VehicleState;
    is_plain =
      (
...
static size_t _VehicleState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_smartfleet_msgs__msg__VehicleState(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, smartfleet_msgs, msg, VehicleState)() {
