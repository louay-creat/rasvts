...
#include "smartfleet_msgs/msg/detail/task_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const smartfleet_msgs::msg::TaskStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  smartfleet_msgs::msg::TaskStatus & ros_message)
{
  // Member: task_id
  cdr >> ros_message.task_id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = smartfleet_msgs::msg::TaskStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const smartfleet_msgs::msg::TaskStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<smartfleet_msgs::msg::TaskStatus *>(
    untyped_ros_message);
...
{
  return &smartfleet_msgs::msg::typesupport_fastrtps_cpp::_TaskStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, smartfleet_msgs, msg, TaskStatus)() {
  return &smartfleet_msgs::msg::typesupport_fastrtps_cpp::_TaskStatus__handle;
}
