...
#include "smartfleet_msgs/msg/detail/vehicle_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const smartfleet_msgs::msg::VehicleState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  smartfleet_msgs::msg::VehicleState & ros_message)
{
  // Member: vehicle_id
  cdr >> ros_message.vehicle_id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = smartfleet_msgs::msg::VehicleState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const smartfleet_msgs::msg::VehicleState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<smartfleet_msgs::msg::VehicleState *>(
    untyped_ros_message);
...
get_message_type_support_handle<smartfleet_msgs::msg::VehicleState>()
{
  return &smartfleet_msgs::msg::typesupport_fastrtps_cpp::_VehicleState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, smartfleet_msgs, msg, VehicleState)() {
  return &smartfleet_msgs::msg::typesupport_fastrtps_cpp::_VehicleState__handle;
}
