...
def generate_launch_description():
    ...
    rplidar_node = Node(
        package='rplidar_ros',
        executable='rplidar_composition',  # change if your exec name is different
    ...
    # Fake odom: integrates /cmd_vel -> /odom and TF odom->base_link
    fake_odom = Node(
    ...
    # Serial bridge: /cmd_vel -> Arduino motors
    serial_bridge = Node(
        package='my_robot_control',
