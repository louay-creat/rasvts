...
bool smartfleet_msgs__msg__task_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("smartfleet_msgs.msg._task_status.TaskStatus", full_classname_dest, 43) == 0);
  }
  smartfleet_msgs__msg__TaskStatus * ros_message = _ros_message;
  {  // task_id
...
PyObject * smartfleet_msgs__msg__task_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("smartfleet_msgs.msg._task_status");
