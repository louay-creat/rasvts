...
#include "smartfleet_msgs/msg/detail/task_status__rosidl_typesupport_fastrtps_c.h"
...
using _TaskStatus__ros_msg_type = smartfleet_msgs__msg__TaskStatus;
...
size_t get_serialized_size_smartfleet_msgs__msg__TaskStatus(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _TaskStatus__ros_msg_type * ros_message = static_cast<const _TaskStatus__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _TaskStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_smartfleet_msgs__msg__TaskStatus(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_smartfleet_msgs
size_t max_serialized_size_smartfleet_msgs__msg__TaskStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = smartfleet_msgs__msg__TaskStatus;
    is_plain =
      (
...
static size_t _TaskStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_smartfleet_msgs__msg__TaskStatus(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, smartfleet_msgs, msg, TaskStatus)() {
