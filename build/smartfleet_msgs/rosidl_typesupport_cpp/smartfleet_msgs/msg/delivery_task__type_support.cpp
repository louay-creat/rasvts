...
static const _DeliveryTask_type_support_symbol_names_t _DeliveryTask_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, smartfleet_msgs, msg, DeliveryTask)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, smartfleet_msgs, msg, DeliveryTask)),
  }
};
...
{
  return &::smartfleet_msgs::msg::rosidl_typesupport_cpp::DeliveryTask_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, smartfleet_msgs, msg, DeliveryTask)() {
  return get_message_type_support_handle<smartfleet_msgs::msg::DeliveryTask>();
}
